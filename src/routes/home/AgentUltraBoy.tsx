...
const AgentUltraBoy = component$<AgentUltraBoyProps>(
  ({ onModelReady$, ...props }) => {
    ...
    const materialSig = useSignal<NoSerialize<pc.StandardMaterial>>();
    ...
    if (
      ...
      materialSig.value = useMaterial({
        ...
        occludeSpecular: 1.0,
        aoIntensity: 1.0,
        ambient: noSerialize(new pc.Color().fromString('#ffffff')),
        ...
        specular: noSerialize(new pc.Color().fromString('#ffffff')),
        ...
        emissive: noSerialize(new pc.Color().fromString('#ffffff')),
        ...
        opacityDither: pc.DITHER_NONE,
        opacityShadowDither: pc.DITHER_NONE,
        ...
        sheenTint: true,
        sheenGlossTint: true,
        attenuation: noSerialize(new pc.Color().fromString('#ffffff')),
        aoMapTiling: noSerialize(new pc.Vec2(1, 1)),
        aoMapOffset: noSerialize(new pc.Vec2()),
        aoMapRotation: 0,
        diffuseMapTiling: noSerialize(new pc.Vec2(1, 1)),
        diffuseMapOffset: noSerialize(new pc.Vec2()),
        diffuseMapRotation: 0,
        specularMapChannel: 'rgb',
        specularMapUv: 0,
        specularMapTiling: noSerialize(new pc.Vec2(1, 1)),
        specularMapOffset: noSerialize(new pc.Vec2()),
        ...
        specularityFactorMapTiling: noSerialize(new pc.Vec2(1, 1)),
        specularityFactorMapOffset: noSerialize(new pc.Vec2()),
        specularityFactorMapRotation: 0,
        enableGGXSpecular: false,
        anisotropy: 0,
        metalnessMapTiling: noSerialize(new pc.Vec2(1, 1)),
        metalnessMapOffset: noSerialize(new pc.Vec2()),
        metalnessMapRotation: 0,
        conserveEnergy: true,
        glossMapTiling: noSerialize(new pc.Vec2(1, 1)),
        glossMapOffset: noSerialize(new pc.Vec2()),
        glossMapRotation: 0,
        clearCoatMapChannel: 'r',
        clearCoatMapUv: 0,
        clearCoatMapTiling: noSerialize(new pc.Vec2(1, 1)),
        clearCoatMapOffset: noSerialize(new pc.Vec2()),
        ...
        clearCoatGlossMapTiling: noSerialize(new pc.Vec2(1, 1)),
        clearCoatGlossMapOffset: noSerialize(new pc.Vec2()),
        clearCoatGlossMapRotation: 0,
        clearCoatGlossVertexColor: false,
        clearCoatGlossVertexColorChannel: 'r',
        clearCoatNormalMapUv: 0,
        clearCoatNormalMapTiling: noSerialize(new pc.Vec2(1, 1)),
        clearCoatNormalMapOffset: noSerialize(new pc.Vec2()),
        clearCoatNormalMapRotation: 0,
        sheenMap: null,
        sheenMapChannel: 'rgb',
        sheenMapUv: 0,
        sheenMapTiling: noSerialize(new pc.Vec2(1, 1)),
        sheenMapOffset: noSerialize(new pc.Vec2()),
        sheenMapRotation: 0,
        sheenGlossMap: null,
        sheenGlossMapChannel: 'r',
        sheenGlossMapUv: 0,
        sheenGlossMapTiling: noSerialize(new pc.Vec2(1, 1)),
        sheenGlossMapOffset: noSerialize(new pc.Vec2()),
        sheenGlossMapRotation: 0,
        emissiveMapTiling: noSerialize(new pc.Vec2(1, 1)),
        emissiveMapOffset: noSerialize(new pc.Vec2()),
        emissiveMapRotation: 0,
        normalMapTiling: noSerialize(new pc.Vec2(1, 1)),
        normalMapOffset: noSerialize(new pc.Vec2()),
        normalMapRotation: 0,
        refractionMap: null,
        refractionMapChannel: 'r',
        refractionMapUv: 0,
        refractionMapTiling: noSerialize(new pc.Vec2(1, 1)),
        refractionMapOffset: noSerialize(new pc.Vec2()),
        ...
        thicknessMapUv: 0,
        thicknessMapTiling: noSerialize(new pc.Vec2(1, 1)),
        thicknessMapOffset: noSerialize(new pc.Vec2()),
        ...
        iridescenceMapUv: 0,
        iridescenceMapTiling: noSerialize(new pc.Vec2(1, 1)),
        iridescenceMapOffset: noSerialize(new pc.Vec2()),
        iridescenceMapRotation: 0,
        iridescenceThicknessMap: null,
        iridescenceThicknessMapChannel: 'r',
        iridescenceThicknessMapUv: 0,
        iridescenceThicknessMapTiling: noSerialize(new pc.Vec2(1, 1)),
        iridescenceThicknessMapOffset: noSerialize(new pc.Vec2()),
        iridescenceThicknessMapRotation: 0,
        heightMapChannel: 'r',
        heightMapUv: 0,
        heightMapTiling: noSerialize(new pc.Vec2(1, 1)),
        heightMapOffset: noSerialize(new pc.Vec2()),
        heightMapRotation: 0,
        heightMapFactor: 1,
        alphaFade: true,
        opacityMapTiling: noSerialize(new pc.Vec2(1, 1)),
        opacityMapOffset: noSerialize(new pc.Vec2()),
        opacityMapRotation: 0,
        opacityFadesSpecular: true,
        cubeMapProjection: 0,
        lightMapChannel: 'rgb',
        lightMapUv: 0,
        lightMapTiling: noSerialize(new pc.Vec2(1, 1)),
        lightMapOffset: noSerialize(new pc.Vec2()),
        lightMapRotation: 0,
        depthTest: true,
        useFog: true,
        useSkybox: true,
