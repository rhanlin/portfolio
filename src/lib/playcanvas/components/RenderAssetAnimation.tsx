...
type RenderAssetAnimationProps = ComponentProps & {
  asset: NoSerialize<Asset>;
};

export const RenderAssetAnimation = component$<RenderAssetAnimationProps>(
  ({ asset, ...props }) => {
    ...
    useVisibleTask$(({ track }) => {
      ...
      const assetResurce =
        (asset?.resource as GlbContainerResource) || undefined;
      if (
        !anim ||
